...
SELECT [telemetry].[AutomatedTest].[AutomatedTestId],
       ...
       [telemetry].[AutomatedTest].[ReplicatedTables],
       [telemetry].[AutomatedTest].[Interations],
       [telemetry].[AutomatedTest].[ResultSetCaching],
       [telemetry].[AutomatedTest].[ResourceClass],
       [telemetry].[AutomatedTest].[OptLevel],
...
GROUP BY 
       [telemetry].[AutomatedTest].[AutomatedTestId],
       [telemetry].[AutomatedTest].[ScriptMods],
       [telemetry].[AutomatedTest].[Mode],
       [telemetry].[AutomatedTest].[DWU],
       [telemetry].[AutomatedTest].[ReplicatedTables],
